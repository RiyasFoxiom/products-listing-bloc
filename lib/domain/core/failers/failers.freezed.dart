...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MainFailers);
}
...
/// @nodoc
class $MainFailersCopyWith<$Res>  {
$MainFailersCopyWith(MainFailers _, $Res Function(MainFailers) __);
}


/// Adds pattern-matching-related methods to [MainFailers].
extension MainFailersPatterns on MainFailers {
...
class _ClientFailure implements MainFailers {
...
@override
String toString() {
  return 'MainFailers.clientFailure()';
}
...
class _ServerFailure implements MainFailers {
...
@override
String toString() {
  return 'MainFailers.serverFailure()';
}
